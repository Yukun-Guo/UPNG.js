...
console.log("png", png.tabs.PLTE.length);
console.log("pngJS", pngJS.palette[4]);

let encoded = UPNG.encode([pngJSData.buffer], pngJS.width, pngJS.height, 8, pngJS.palette);